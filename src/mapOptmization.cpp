...
//            correctPoses();
    ...
    */
    ...
    void initializeGlobalMap() {
      ...
      pcl::io::loadPCDFile(globalmap_pcd, *cloudSurfMap);
      pcl::io::loadPCDFile(globalmap_pcd, *cloudCornerMap);
  ...
  bool Filter(const pcl::PointCloud<PointType>::Ptr &input_cloud_ptr, pcl::PointCloud<PointType>::Ptr &filtered_cloud_ptr) {
